# Django settings for boru project.
...
DATABASES = {
    'default': {
        ...
        'NAME': 'borusystem',                      # Or path to database file if using sqlite3.
...
SECRET_KEY = 'o@=@o5i!94u(d8yc_6v=j$utqx9cefto^9mm6_2&2bu%@)gm_!'
...
ROOT_URLCONF = 'boru.urls'

# Python dotted path to the WSGI application used by Django's runserver.
WSGI_APPLICATION = 'boru.wsgi.application'
...
INSTALLED_APPS = (
    ...
    'gestiones.Salon.altasector',
    'gestiones.Salon.modificarsector',
...
PAGINADO_PRODUCTOS_MENUES = 4
PAGINADO_USUARIOS = 5
TOTAL_LINEAS_PDF = 40
MARGEN_TITULO_PDF = 3
PAGINADO_SECCIONES = 10