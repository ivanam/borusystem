...
class Personal(User):
    ...
    TURNOS_MOZOS = (("Noche", "Noche"), ("Tarde", "Tarde"), ("Maniana", "Mañana"),)
    ...
    User.add_to_class('numeroDoc', models.PositiveIntegerField("Nº Documento", max_length=8, null=True, blank=True))
